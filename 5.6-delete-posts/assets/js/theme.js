(function () {
  ...
  function deletePost(event) {
    let title =
        event.target.parentElement.querySelector(".entry-title a").innerText,
  ...
  function loadEditForm(event) {
    let title =
        event.target.parentElement.querySelector(".entry-title a").innerText,
      content =
        event.target.parentElement.querySelector(".entry-content").innerHTML,
      id = event.target.parentElement.dataset.id;
